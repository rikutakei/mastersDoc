...
The raw microarray gene expression data files of all *** samples from the  Print et al. study were downloaded from the \gls{geo} database (include website name/GEO ID here).
Clinical data for the samples in this study was not available.
*** obesity associated gene probes identified by Print et al. were downloaded from (supplementary data??).
The raw expression data and the list of gene probes were imported into \gls{r}/RStudio.
...
Only the Affymetrix HGU133A microarray samples were included in the project.
Clinical data for the samples in this study was not available.
*** obesity associated gene probes identified by \citet{Gatza2010a} were downloaded from (supplementary data??).
The raw expression data and the list of gene probes were imported into \gls{r}/RStudio.
