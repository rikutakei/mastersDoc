...
Since all of the obesity metagenes failed to show significant association with patient \gls{bmi}, it may be possible that these pathways (Akt, \gls{er}, \gls{egfr}, \gls{pr}, p53, Src and \gls{tgfb}) are related to the underlying biological mechanism that drives the breast tumour development.
...
The results from the linear model prediction suggested that the Akt, \gls{egfr} and Src pathways may be important in breast tumour development and/or progression.
