...
The obesity metagene from the \citet{Fuentes-Mattei2014} study was a cluster on its own, where the metagene did not cluster with any of the Creighton \textit{et al.} obesity metagenes nor with the Gatza \textit{et al.} pathway metagene.
