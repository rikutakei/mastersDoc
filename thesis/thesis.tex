...
\usepackage{subcaption}    % package for formatting figure caption
\usepackage[toc]{appendix}    % package for formatting figure caption
...
\includeonly{{./methods/methods},{./results/results},{./misc/appendix}}
