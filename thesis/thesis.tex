...
\usepackage{etoolbox}                                % package for scientific notations and units
\usepackage{bm}                                % package for scientific notations and units
...
\robustify\bfseries
\sisetup{detect-all}
% \sisetup{detect-weight=true,detect-family=true,detect-inline-weight=math,table-parse-only}
...
\includeonly{{./methods/methods},{./results/results},{./results/results2},{./misc/appendix}}
