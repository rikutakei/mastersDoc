...
\begin{table}[htpb]
	...
	\begin{threeparttable}
			...
			\end{tabular}
			\begin{tablenotes}
				\item [*] All values in bold are statistically significant (p \textless{} 0.05).
			\end{tablenotes}
	\end{threeparttable}
\end{table}
% \begin{table}[htpb]
...
% 				\hline
% 				\rule{0pt}{2.25ex}\gls{bmi} and \gls{pr}                   & \gls{bmi}  & -0.002 & 0.586\\
%                                                                            & \gls{pr}   & 0.478  & 6.35 \times10^{-7}\\
% 				\hline
% 				\rule{0pt}{2.25ex}\gls{bmi} status and \gls{pr}            & Obese      & -0.085 & 0.176\\
%                                                                            & Overweight & -0.011 & 0.875\\
%                                                                            & \gls{pr}   & 0.471  & 8.25 \times10^{-7}\\
% 				\hline
% 				\rule{0pt}{2.25ex}\gls{bmi}, \gls{bmi} status and \gls{pr} & \gls{bmi}  & 0.007  & 0.237\\
%                                                                            & Obese      & -0.188 & 0.081\\
%                                                                            & Overweight & -0.049 & 0.516\\
%                                                                            & \gls{pr}   & 0.459  & 1.54 \times10^{-6}\\
% 				\hline
% 				\hline
% 			\end{tabular}
% 			\begin{tablenotes}
