...
\begin{table}[htpb]
	...
	\caption{Summary of the Spearman correlations of the pathway metagenes generated from \gls{svd} and the application of the transformation matrices\tnote{1} in Gatza \textit{et al.}, Creighton \textit{et al.}, Print \textit{et al.} and Fuentes-Mattei \textit{et al.} data sets}
...
\begin{table}[htpb]
	\centering
	\begin{threeparttable}
		\caption{Summary of the Spearman correlations of the obesity metagenes generated from \gls{svd} and the application of the transformation matrices\tnote{1} in Gatza \textit{et al.}, Creighton \textit{et al.}, Print \textit{et al.} and Fuentes-Mattei \textit{et al.} data sets}
...
\begin{table}[htpb]
	\centering
	\caption{Description of the linear models used to predict the CR obesity metagene in Print \textit{et al.} data set, using only the sample \gls{bmi}, \gls{bmi} status and \gls{pr} pathway metagene scores}
