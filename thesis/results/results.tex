...
After this, novel obesity-associated genetic signatures were identified in the Creighton \textit{et al.} (CR) data set and was compared with the obesity-associated genetic signatures from the \citet{Creighton2012} and the \citet{Fuentes-Mattei2014}  studies.
...
\begin{figure}[tb!]
	...
	Level of expression is represented in the top left histogram, where low and high gene expression are colour-coded with blue and red, respectively.
...
Though the log$_{10}$-normalisation and standardisation of the data were the most appropriate adjustments to be made to the \gls{rnaseq} data, these adjustments were not equivalent to the \gls{rma}-normalisation method that was used on the microarray data.
...
The clinical variables controlled were age, ethnicity, menopause status, tumour grade, receptor (\gls{er}, \gls{pr}, and \gls{her2}) statuses  and \gls{ln} status.
...
\begin{figure}[tpb]
	...
	High and low correlation were represented as red and yellow, respectively, where the colours were matched with the values on the scale shown in the top left histogram.
...
Taken together, these results showed that, even though all of the obesity metagenes significantly associated with the patient \gls{bmi} and \gls{bmi} status in the original data where the genetic signatures were derived from, none of the metagenes were generalisable in other cancer data sets.
...
It was clear that all of the obesity-associated genetic signatures created from the CR data set were not significantly associated with patient \gls{bmi} across different \gls{icgc} cancer data sets.
