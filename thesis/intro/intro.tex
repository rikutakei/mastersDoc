...
\gls{pyy} is a gut hormone that is secreted postprandially, and it is released at levels proportional to the calorie content of the meal (original citation, Adrian1985 gastroenterology).
...
There are many evidence of obesity being caused by individual-level genetic factors that make some individuals more predisposed to obesity than others (citation).
Generally speaking, there are two classes of genetic-driven obesity: monogenic obesity and polygenic obesity \citep{Moustafa2013}. \\
...
These observations in the rise in obesity in subsets of population cannot be explained simply by external factors alone, and there is a significant genetic component involved \citep{Bell2005}.
\\
