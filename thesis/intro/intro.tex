...
% The current obesity status of the adult population is high already, but the fact that more of the younger population who are overweight and obese poses a much greater risk for the health of the population in the future.
...
\gls{nz} not only has a high prevalence of obesity compared to many other countries of the world, but also has a unique health problem that affects Pacific and M\=aori populations more than the rest of the \gls{nz} population.
...
The activation of the K$^+$ channel provided evidence for the two pathways to act similarly on the cell, at least for an acute response, suggesting a convergence in the pathway response by the two hormones, and therefore their role in satiety control.
...
% Though these sort of mutations are very rare and affects only those individuals that have these mutations, it had a profound impact in the field of obesity research and contributed significantly to the knowledge of the mechanism of the development of obesity.
...
Until these studies came out, there has been no common genes or genomic regions associated with obesity that was reproducible and reliable \citep{Frayling2007}.
...
With the help from government trade policies, food and other goods have become easier to trade between countries, helping the economic growth of many countries around the world \citep{Kearney2010}.
This led to a greater abundance of food in general, a greater number of food choices and shifted the overall nutritional status of countries \citep{Malik2013}.
This shift in food choice and availability (and the economic benefit associated with the trades) had a positive impact on countries, but the growth in the food market also resulted in the population-wide rise in obesity.
...
As a result, more people are inclined to consume foods that are cheap, have little nutritional value and high in energy, than foods that are expensive, nutritional and healthy alternatives.
...
As more people take up urban lifestyle, they are exposed to new environments where there is a better range of food selection, as well as technological and mechanical advancement in transport and other daily chores that may not be available in rural areas.
Although there are many advantages involved with urbanisation, such as access to developed health care systems, education and advanced technologies, the lifestyle change also imposes negative health behaviour that ultimately can lead to positive energy balance and obesity \citep{Malik2013}.
