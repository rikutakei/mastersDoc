...
Once mobile and invasive, these metastatic cancer cell is able to circulate through the vascular system and eventually invade the target organ, where it must undergo \gls{met} and colonise the site, and eventually metastasise from this site \citep{Hanahan2011,Kalluri2009}.
...
There are two key transcription factors that connect the two pathways of inflammation that ultimately leads to the prommotion  of many, if not all, of the hallmarks discussed so far: \gls{nfkb} and \gls{stat3} \citep{Mantovani2008}.
