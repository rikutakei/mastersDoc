...
A relatively recent review by \citet{Perez-Solis2016} describes potential mechanism in which obesity, alcoholism and smoking (all a lifestyle factor related to obesity) may regulate gene expression in breast cancer cells.
...
In addition to this, there has also been evidence of serum from obese patient influencing the gene expression of sex hormone receptor (estrogen receptor $\beta$) in a breast cancer cell line, suggesting there may be a gene regulatory effect caused by the obese phenotype \citep{Bowers2015}.
...
Major concern with this study was the quality of the \acrshort{rna} that was collected from the samples.
...
However, this did not control for the quality of the \acrshort{rna} that has been extracted, as some samples may have had significantly less tumour volume compared to another, but still have $\geq$ 70\% tumour cells in both samples.
