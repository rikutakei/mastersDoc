...
Even though some individual-level factors are involved with obesity, it is clear that these individual-level factors cannot be accounted for the global epidemic of obesity that the world observes.
...
\textit{(Expand on this -- better trades around the globe (?)) \citep{Kearney2010, Malik2013}}

The second factor to consider is the behavioural changes led by the urbanisation of the population.
\textit{(Expand on this -- physical activity, sociocultural norm, etc.\citep{Malik2013})}

The third factor is the income and socioeconomic status of the countries.
\textit{(Expand on this -- rise in income, availability of health care, etc.\citep{Malik2013})}
