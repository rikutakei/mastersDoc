...
When a satiety-controlling hormone, such as leptin, reaches the arcuate nucleus region of the hypothalamus, it can stimulate or inhibit orexogenic, anorexogenic, or both neurons.
...
Firstly, when an orexogenic \gls{npy}/\gls{agrp} neurons are stimulated,
