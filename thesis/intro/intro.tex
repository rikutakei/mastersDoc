...
Though more will be covered in details in \cref{sec:obesity_and_cancer}: \nameref{sec:obesity_and_cancer}, the effect of obesity on cancers will be briefly mentioned here.
...
\begin{table}[h]
	...
	\begin{threeparttable}
		\caption{Summary of the risk ratios\tnote{1} that significantly associated with each type of cancers from \citet{Renehan2008} study\tnote{2}.}
...
There are several hypotheses that links obesity with cancers: disruption of various hormone levels, chronic and sustained inflammation, and activation of the \gls{igf} pathway.
...
Unlike leptin, where the concentration of leptin is higher in obese people, adiponectin levels are lower in obese people compared to the normal weight people \citep{Kelesidis2006a}.
