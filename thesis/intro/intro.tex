...
\noindent
Approximately 1 in every 14 people in the world were classed as obese in 2014; therefore, 1 in every 14 people around the world were also at risk of the severe health consequences associated with obesity.
...
Diet and obesity are also known risk factors for many types of cancers \citep{Ames1995,Calle2004}.
...
A relatively recent review by \citet{Perez-Solis2016} describes potential mechanisms in which obesity, alcoholism and smoking (all lifestyle factors related to obesity) may regulate gene expression in breast cancer cells.
...
It is not surprising that different environmental factors affect different Master transcriptional factors, and therefore have different biological mechanisms of gene regulation.

It is also worth noting here that an individual may be exposed to  multiple  environmental factors at any given point of time, and perhaps a combination of multiple environmental factors may have more significant effect on the individual.
...
In addition to this, there has also been evidence of serum from obese patients influencing the gene expression of sex hormone receptor (estrogen receptor $\beta$) in a breast cancer cell line, suggesting there may be a gene regulatory effect caused by the obese phenotype \citep{Bowers2015}.
Through the effects of dysregulated levels of hormones and hormone receptors, obesity may have significant impact on the tumour biology through changes in gene expression level.

On top of the effects that \glspl{adipocyte} have on circulating concentration of sex hormones as well as gene expression of sex hormone receptors, \glspl{adipocyte} also produce adipose tissue-specific hormones called adipokines \citep{Roberts2010}.
...
The tumour samples were trimmed upon collection, to ensure all of the samples had $\geq$ 70\% tumour cells before \acrshort{rna} was extracted from the samples.
...
One major concern with this study was the quality of the \acrshort{rna} that was collected from the samples.
Ensuring that all of the samples had more than 70\% of tumour cells meant that the \acrshort{rna} was likely from the tumour cells.
However, this did not control for the quality of the \acrshort{rna} that was extracted, as some samples may have had significantly less tumour volume compared to another, but still have $\geq$ 70\% tumour cells in both samples.
Another thing to note from this paper was the predictive ability of their obesity signatures in other data sets.
\citet{Creighton2012} used six independent breast cancer  data sets to test whether their signature was able to replicate their findings.
Although they were able to replicate their results in one of the data sets, they were not able to find any significant association in the other data sets.
...
One minor thing to point out in this paper was that the normalisation procedure carried out before the differential expression analysis was not clear.

On top of the bioinformatic analysis that was carried out, \citet{Fuentes-Mattei2014} validated their results using a mouse model, where they compared the expression level in the breast tumours from the obese mice with those from the lean mice.
